...
public class UTS {
    public static void main(String[] args) {
        ...
        System.out.println("UTS 20 Mei 2024 oleh Ahmad Fadlillah NIM 23201237");
        System.out.println("xxxxxxxxxxxxxxxxxxxxxxxxxx");
        
        // Input nama
        System.out.println("Ahmad Fadlillah");
        ...
        // Menampilkan selamat datang
         System.out.println("Selamat Datang " + panggilan + " Afad" + nama);
        //9
